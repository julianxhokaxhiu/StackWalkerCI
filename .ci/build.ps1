...
Set-Location ${env:buildPath}\StackWalker

git apply ${env:buildPath}\StackWalkerCI\CMakeLists.patch
...
Move-Item $env:_RELEASE_PATH\${env:_RELEASE_CONFIGURATION}\StackWalker.lib ${env:buildPath}\.install\lib
Move-Item Main/StackWalker/StackWalker.h ${env:buildPath}\.install\include
